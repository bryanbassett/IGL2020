...
?>
<?php	get_template_part( 'template-parts/hero-campaign'); ?>
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>

	<header class="bg-center entry-header flex flex-col inline-block m-auto ml-auto mr-auto mt-0 text-center" >
		
		<div class="mb-auto mt-auto">
			<h1 class="m-auto  pt-4 pb-4  text-6xl w-11/12  sm:w-6/12  igl-text-secondary  font-primary uppercase hidden"><?php the_title() ?></h1>
		</div>
	</header><!-- .entry-header -->
